class Admins::RecipesController < DashboardsController 
  ...
  def create
    ...
    respond_to do |format|
      if @recipe.save
        format.turbo_stream
        format.html { redirect_to admins_recipe_url(@recipe), notice: "Recipe was successfully created." }
  ...
  def update
    ...
    respond_to do |format|
      if @recipe.update(recipe_params)
        format.html { redirect_to edit_admins_recipe_url(@recipe), notice: "Recipe was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.turbo_stream
      format.html { redirect_to admins_recipes_url, notice: "Recipe was successfully destroyed." }
